# Modified version, originally contributed by c0bra5 
#   - https://github.com/cmdr2/stable-diffusion-ui/pull/619
# which was a cut down version of 
#   - https://github.com/AUTOMATIC1111/stable-diffusion-webui/blob/
#   c9a2cfdf2a53d37c2de1908423e4f548088667ef/modules/hypernetworks/hypernetwork.py
...
class HypernetworkModule(torch.nn.Module):
    ...
    activation_dict.update(
        {
            ...
            for cls_name, cls_obj in
            inspect.getmembers(torch.nn.modules.activation)
            if inspect.isclass(cls_obj) and
            cls_obj.__module__ == 'torch.nn.modules.activation'
        }
    )
    ...
    def __init__(
        ...
        for i in range(len(layer_structure) - 1):
            ...
            if activation_func == "linear" or activation_func is None or \
                ...
                raise RuntimeError(
                    f'hypernetwork uses an unsupported '
            ...
            structure_length = len(layer_structure)
            # Add dropout except last layer
            if use_dropout and (i < structure_length - 3 or
                                last_layer_dropout and
                                i < structure_length - 2
                                ):
    ...
    def fix_old_state_dict(self, state_dict) -> None:
        changes = {
...
def apply_hypernetwork(hypernetwork, attention_context, layer=None):
    """
        Apply the hypernetwork to the attention context.
    """
